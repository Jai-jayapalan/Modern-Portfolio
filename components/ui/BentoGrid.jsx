...
export const BentoGridItem = ({ className, title, description, id, img, imgClassName, spareImg, titleClassName }) => {
    ...
    useEffect(() => {
      // This ensures `document` is only used in the browser.
    ...
    const handleCopy = () => {
      if (typeof navigator !== "undefined") {
          const text = "jaijayathilak@gmail.com";
          ...
          {id === 3 && (
            <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2">
              <div className="flex flex-col gap-3 md:gap-3 lg:gap-3">
                ...
                <span className="lg:py-2 lg:px-3 py-2 px-3 rounded-lg text-center bg-[#10132E]"></span>
              </div>
              <div className="flex flex-col gap-3 md:gap-3 lg:gap-3">
                <span className="lg:py-2 lg:px-3 py-2 px-3 rounded-lg text-center bg-[#10132E]"></span>
